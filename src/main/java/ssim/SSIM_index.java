 ...
 * "SSIM Index as a Java plugin for ImageJ" Department of Radiology, Faculty of
...
public class SSIM_index implements PlugIn {
    ...
    public void run(String arg) {
        ...
        double ssim_index;
        //
        // ERROR CONTROLS. TWO IMAGES SHOULD BE OPENED AND BOTH WITH THE SAME
        // DIMENSIONS
        //
        ...
        //
        //
        // THIS DIALOG BOX SHOWS DIFFERENT OPTIONS TO CREATE THE WINDOW WE ARE
        // GOING TO USE TO EVALUATE SSIM INDEX OVER THE ENTIRE IMAGES
        //
        ...
        String[] window_type = { "Gaussian", "Same weight" }; // WE CAN WEIGHTS
                                                              // THE WINDOW WITH
                                                              // A GAUSSIAN
                                                              // WEIGHTING
                                                              // FUNCTION OR
